...
const breakfast = DinnerFromChef.dinnerForGuests("Toast", "Egg", "Bacon");
console.log(breakfast);

const lunch = DinnerFromChef.dinnerForGuests("Spaghetti", "Bacon", "Eggplant");
console.log(lunch);

const dinnerTime = DinnerFromChef.dinnerForGuests("Rice", "Chicken", "Rolls");
